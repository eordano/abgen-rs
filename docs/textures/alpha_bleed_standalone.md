...
> alpha bleed is a jump-flood (nearest-seed-wins, no averaging); the averaging-based
> dilation described here was not the final approach. Kept for the paper trail.
